...
export class RouletteV1__betsResult {
  value0: BigInt;
  value1: BigInt;
  value2: boolean;
  value3: Address;
...
export class RouletteV1__chainlinkConfigResult {
  value0: BigInt;
  value1: Bytes;
  value2: BigInt;
  value3: BigInt;
...
export class RouletteV1__getBetResultValue0Struct extends ethereum.Tuple {
...
export class RouletteV1 extends ethereum.SmartContract {
  static bind(address: Address): RouletteV1 {
    return new RouletteV1("RouletteV1", address);
  }
  ...
  bets(param0: BigInt): RouletteV1__betsResult {
    ...
    return new RouletteV1__betsResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBoolean(),
      result[3].toAddress(),
  ...
  try_bets(param0: BigInt): ethereum.CallResult<RouletteV1__betsResult> {
  ...
  chainlinkConfig(): RouletteV1__chainlinkConfigResult {
    let result = super.call(
      "chainlinkConfig",
    ...
    return new RouletteV1__chainlinkConfigResult(
      result[0].toBigInt(),
      result[1].toBytes(),
      result[2].toBigInt(),
      result[3].toBigInt()
  ...
  try_chainlinkConfig(): ethereum.CallResult<
    RouletteV1__chainlinkConfigResult
  > {
    let result = super.tryCall(
      "chainlinkConfig",
      "chainlinkConfig():(uint64,bytes32,uint256,uint32)",
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new RouletteV1__chainlinkConfigResult(
        value[0].toBigInt(),
        value[1].toBytes(),
        value[2].toBigInt(),
        value[3].toBigInt()
  ...
  getBet(betId: BigInt): RouletteV1__getBetResultValue0Struct {
    let result = super.call(
      "getBet",
    ...
    return changetype<RouletteV1__getBetResultValue0Struct>(
      result[0].toTuple()
    );
  }
  ...
  try_getBet(
    betId: BigInt
  ): ethereum.CallResult<RouletteV1__getBetResultValue0Struct> {
    let result = super.tryCall(
      "getBet",
      "getBet(uint256):((uint32,uint32,bool,address,address,uint256,uint256,uint256,uint256,bool,bool,uint256))",
      [ethereum.Value.fromUnsignedBigInt(betId)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      changetype<RouletteV1__getBetResultValue0Struct>(value[0].toTuple())
    );
  }
