...
export class CoinflipV1__betsResult {
  value0: BigInt;
  value1: BigInt;
  value2: boolean;
  value3: Address;
...
export class CoinflipV1__chainlinkConfigResult {
  value0: BigInt;
  value1: Bytes;
  value2: BigInt;
  value3: BigInt;
...
export class CoinflipV1__getBetResultValue0Struct extends ethereum.Tuple {
...
export class CoinflipV1 extends ethereum.SmartContract {
  static bind(address: Address): CoinflipV1 {
    return new CoinflipV1("CoinflipV1", address);
  }
  ...
  bets(param0: BigInt): CoinflipV1__betsResult {
    ...
    return new CoinflipV1__betsResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBoolean(),
      result[3].toAddress(),
  ...
  try_bets(param0: BigInt): ethereum.CallResult<CoinflipV1__betsResult> {
  ...
  chainlinkConfig(): CoinflipV1__chainlinkConfigResult {
    let result = super.call(
      "chainlinkConfig",
    ...
    return new CoinflipV1__chainlinkConfigResult(
      result[0].toBigInt(),
      result[1].toBytes(),
      result[2].toBigInt(),
      result[3].toBigInt()
  ...
  try_chainlinkConfig(): ethereum.CallResult<
    CoinflipV1__chainlinkConfigResult
  > {
    let result = super.tryCall(
      "chainlinkConfig",
      "chainlinkConfig():(uint64,bytes32,uint256,uint32)",
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new CoinflipV1__chainlinkConfigResult(
        value[0].toBigInt(),
        value[1].toBytes(),
        value[2].toBigInt(),
        value[3].toBigInt()
  ...
  getBet(betId: BigInt): CoinflipV1__getBetResultValue0Struct {
    let result = super.call(
      "getBet",
    ...
    return changetype<CoinflipV1__getBetResultValue0Struct>(
      result[0].toTuple()
    );
  }
  ...
  try_getBet(
    betId: BigInt
  ): ethereum.CallResult<CoinflipV1__getBetResultValue0Struct> {
    let result = super.tryCall(
      "getBet",
      "getBet(uint256):((uint32,uint32,bool,address,address,uint256,uint256,uint256,uint256,bool,bool,uint256))",
      [ethereum.Value.fromUnsignedBigInt(betId)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      changetype<CoinflipV1__getBetResultValue0Struct>(value[0].toTuple())
    );
  }
