...
export class FortuneRollV1__betsResult {
  value0: BigInt;
  value1: BigInt;
  value2: boolean;
  value3: Address;
...
export class FortuneRollV1__chainlinkConfigResult {
  value0: BigInt;
  value1: Bytes;
  value2: BigInt;
  value3: BigInt;
...
export class FortuneRollV1__getBetResultValue0Struct extends ethereum.Tuple {
...
export class FortuneRollV1 extends ethereum.SmartContract {
  static bind(address: Address): FortuneRollV1 {
    return new FortuneRollV1("FortuneRollV1", address);
  }
  ...
  bets(param0: BigInt): FortuneRollV1__betsResult {
    ...
    return new FortuneRollV1__betsResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBoolean(),
      result[3].toAddress(),
  ...
  try_bets(param0: BigInt): ethereum.CallResult<FortuneRollV1__betsResult> {
  ...
  chainlinkConfig(): FortuneRollV1__chainlinkConfigResult {
    let result = super.call(
      "chainlinkConfig",
    ...
    return new FortuneRollV1__chainlinkConfigResult(
      result[0].toBigInt(),
      result[1].toBytes(),
      result[2].toBigInt(),
      result[3].toBigInt()
  ...
  try_chainlinkConfig(): ethereum.CallResult<
    FortuneRollV1__chainlinkConfigResult
  > {
    let result = super.tryCall(
      "chainlinkConfig",
      "chainlinkConfig():(uint64,bytes32,uint256,uint32)",
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new FortuneRollV1__chainlinkConfigResult(
        value[0].toBigInt(),
        value[1].toBytes(),
        value[2].toBigInt(),
        value[3].toBigInt()
  ...
  getBet(betId: BigInt): FortuneRollV1__getBetResultValue0Struct {
    let result = super.call(
      "getBet",
    ...
    return changetype<FortuneRollV1__getBetResultValue0Struct>(
      result[0].toTuple()
    );
  }
  ...
  try_getBet(
    betId: BigInt
  ): ethereum.CallResult<FortuneRollV1__getBetResultValue0Struct> {
    let result = super.tryCall(
      "getBet",
      "getBet(uint256):((uint32,uint32,bool,address,address,uint256,uint256,uint256,uint256,bool,bool,uint256))",
      [ethereum.Value.fromUnsignedBigInt(betId)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      changetype<FortuneRollV1__getBetResultValue0Struct>(value[0].toTuple())
    );
  }

  getMul(options: BigInt, houseEdge: BigInt): BigInt {
    let result = super.call("getMul", "getMul(uint256,uint256):(uint256)", [
      ethereum.Value.fromUnsignedBigInt(options),
      ethereum.Value.fromUnsignedBigInt(houseEdge)
    ]);

    return result[0].toBigInt();
  }

  try_getMul(options: BigInt, houseEdge: BigInt): ethereum.CallResult<BigInt> {
    let result = super.tryCall("getMul", "getMul(uint256,uint256):(uint256)", [
      ethereum.Value.fromUnsignedBigInt(options),
      ethereum.Value.fromUnsignedBigInt(houseEdge)
    ]);
    if (result.reverted) {
  ...
  getWinAmount(betAmount: BigInt, betOptions: BigInt): BigInt {
    let result = super.call(
      "getWinAmount",
      "getWinAmount(uint256,uint256):(uint256)",
      [
        ethereum.Value.fromUnsignedBigInt(betAmount),
        ethereum.Value.fromUnsignedBigInt(betOptions)
      ]
    );
  ...
  hasWon(options: BigInt, winNumber: BigInt): boolean {
    let result = super.call("hasWon", "hasWon(uint256,uint256):(bool)", [
      ethereum.Value.fromUnsignedBigInt(options),
      ethereum.Value.fromUnsignedBigInt(winNumber)
    ]);

    return result[0].toBoolean();
  }

  try_hasWon(options: BigInt, winNumber: BigInt): ethereum.CallResult<boolean> {
    let result = super.tryCall("hasWon", "hasWon(uint256,uint256):(bool)", [
      ethereum.Value.fromUnsignedBigInt(options),
      ethereum.Value.fromUnsignedBigInt(winNumber)
    ]);
    if (result.reverted) {
