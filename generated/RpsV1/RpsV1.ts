...
export class RpsV1__betsResult {
  value0: BigInt;
  value1: BigInt;
  value2: boolean;
  value3: Address;
...
export class RpsV1__chainlinkConfigResult {
  value0: BigInt;
  value1: Bytes;
  value2: BigInt;
  value3: BigInt;
...
export class RpsV1__getBetResultValue0Struct extends ethereum.Tuple {
...
export class RpsV1 extends ethereum.SmartContract {
  static bind(address: Address): RpsV1 {
    return new RpsV1("RpsV1", address);
  }
  ...
  bets(param0: BigInt): RpsV1__betsResult {
  ...
  try_bets(param0: BigInt): ethereum.CallResult<RpsV1__betsResult> {
  ...
  chainlinkConfig(): RpsV1__chainlinkConfigResult {
    let result = super.call(
      "chainlinkConfig",
    ...
    return new RpsV1__chainlinkConfigResult(
      result[0].toBigInt(),
      result[1].toBytes(),
      result[2].toBigInt(),
      result[3].toBigInt()
  ...
  try_chainlinkConfig(): ethereum.CallResult<RpsV1__chainlinkConfigResult> {
    let result = super.tryCall(
      "chainlinkConfig",
      "chainlinkConfig():(uint64,bytes32,uint256,uint32)",
      []
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new RpsV1__chainlinkConfigResult(
        value[0].toBigInt(),
        value[1].toBytes(),
        value[2].toBigInt(),
        value[3].toBigInt()
  ...
  getBet(betId: BigInt): RpsV1__getBetResultValue0Struct {
    let result = super.call(
      "getBet",
    ...
    return changetype<RpsV1__getBetResultValue0Struct>(result[0].toTuple());
  }

  try_getBet(
    betId: BigInt
  ): ethereum.CallResult<RpsV1__getBetResultValue0Struct> {
    let result = super.tryCall(
      "getBet",
      "getBet(uint256):((uint32,uint32,bool,address,address,uint256,uint256,uint256,uint256,bool,bool,uint256))",
      [ethereum.Value.fromUnsignedBigInt(betId)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      changetype<RpsV1__getBetResultValue0Struct>(value[0].toTuple())
    );
  }
